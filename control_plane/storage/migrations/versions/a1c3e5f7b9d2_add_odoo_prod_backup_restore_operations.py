"""add Odoo production backup restore operations

Revision ID: a1c3e5f7b9d2
Revises: f4c6e8a0b2d4
...
down_revision: str | None = "f4c6e8a0b2d4"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_TABLE = "launchplane_odoo_prod_backup_restore_operations"
_LANE_STATUS_INDEX = "launchplane_odoo_restore_operation_lane_status_idx"
_IDEMPOTENCY_INDEX = "launchplane_odoo_restore_operation_idempotency_idx"
_ACTIVE_LANE_INDEX = "launchplane_odoo_restore_active_lane_uidx"
_WORKER_CLAIM_INDEX = "launchplane_odoo_restore_worker_claim_idx"
