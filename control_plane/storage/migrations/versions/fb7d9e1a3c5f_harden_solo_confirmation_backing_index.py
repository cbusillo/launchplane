...
_OLD_INDEX = "launchplane_solo_administration_confirmation_consumed_candidate_idx"
_INDEX = "launchplane_solo_administration_confirmation_consumed_recovery_activation_idx"
