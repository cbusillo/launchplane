...
OPERATION_SPECS = (
    ...
    OperationSpec(
        ...
        "Prepare a bounded unsigned authorization recovery challenge.",
        ("agent_helper", "operator_cli", "service_api"),
        ("prepare",),
        "none",
        (),
    ),
    OperationSpec(
        ...
        "Read a redacted prepared authorization recovery challenge.",
