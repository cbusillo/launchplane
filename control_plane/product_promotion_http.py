...
class ProductPromotionStatus(BaseModel):
    ...
    release_review: ReleaseReviewStatus = Field(default_factory=ReleaseReviewStatus)
...
def build_product_promotion_status(
    *,
    ...
    release_review = current_release_review(
    ...
    return _canonical_sha256(
        {
            ...
            "release_review": {
                "required": release_review.required,
                "approved": release_review.approved,
                "checklist_digest": release_review.checklist_digest,
                "decision_id": release_review.latest_decision.record_id
                if release_review.latest_decision
                else "",
            },
